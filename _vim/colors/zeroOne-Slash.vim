...
let g:colors_name = 'zeroOne-Slash'
...
let s:cursor            = { "gui": "#FFFFFF" }
let s:cursor_bg         = { "gui": "#ff0073" }

let s:tag_bg            = { "gui": "#C7E4E7" }
let s:tag_bg_name       = { "gui": "#C7E4E7" }
let s:tag_bg_attr       = { "gui": "#C7E4E7" }
let s:tag_bg_str        = { "gui": "#F7F5DD" }
let s:tag_bg_end        = { "gui": "#c5dbe7" }

let s:tag_fg            = { "gui": "#333333" }
let s:tag_fg_name       = { "gui": "#000000" }
let s:tag_fg_end        = { "gui": "#666666" }
